...
- **Modes and Routines support**: This is built for modes and routines from the ground up with notification support. You can trigger actions from your watch when your phone receives a notification from ChargeNotifier.   
